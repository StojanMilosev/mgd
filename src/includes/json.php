...
$aleksandrija = $kondiktorski_program[2]['aleksandrija'];
$zeneva_lesnica = $kondiktorski_program[3]['zeneva_lesnica'];
//testenine
$testenine = $json['testenine'];
$sentela = $testenine[1]['sentela'];
$danubis  = $testenine[2]['danubis'];
$renesansa  = $testenine[3]['renesansa'];
//pakeraj
$pakeraj = $json['pakeraj'];
$koktel_sivac = $pakeraj[1]['koktel_sivac'];
$koktel_sivac = $pakeraj[2]['ares'];
...
$tisa_becej = $hemija[2]['tisa_becej'];
$tekstil = $hemija[3]['tekstil'];
